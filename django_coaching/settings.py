"""
Django settings for django_coaching project.
...
SECRET_KEY = '!!&l6kz!cj63*j8j44tyeuf1y*d2ub7csto2%x0^k1(n82m3a#'
...
ROOT_URLCONF = 'django_coaching.urls'
...
WSGI_APPLICATION = 'django_coaching.wsgi.application'
